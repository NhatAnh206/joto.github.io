...
<body class="animsition">
	...
	<section class="section-slide">
		<div class="wrap-slick1">
			<div class="slick1">
				<div class="item-slick1 item1-slick1" style="background-image: url(images/background.jpg); background-attachment: fixed;">
				...
				<div class="item-slick1 item2-slick1" style="background-image: url(images/background-1.jpg); background-attachment: fixed;">
					<div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
				...
				<div class="item-slick1 item3-slick1" style="background-image: url(images/background-2.jpg); background-attachment: fixed;">
					<div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
	...
	<section class="section-intro">
		<div class="header-intro parallax100 t-center p-t-135 p-b-158" style="background-image: url(images/background-discover.jpg);">
			...
			<div class="slick3">
					...
					<div class="wrap-content-slide3 p-b-50 p-t-50">
						<div class="container">
							<div class="pic-review size14 bo4 wrap-cir-pic m-l-r-auto animated visible-false" data-appear="zoomIn">
								<img src="images/anh.jpg" alt="IGM-AVATAR">
							</div>
				...
				<div class="item-slick3 item2-slick3">
					<div class="wrap-content-slide3 p-b-50 p-t-50">
						<div class="container">
							<div class="pic-review size14 bo4 wrap-cir-pic m-l-r-auto animated visible-false" data-appear="zoomIn">
								<img src="images/avatar-anh5.jpg" alt="IGM-AVATAR">
							</div>
				...
				<div class="item-slick3 item3-slick3">
					<div class="wrap-content-slide3 p-b-50 p-t-50">
						<div class="container">
							<div class="pic-review size14 bo4 wrap-cir-pic m-l-r-auto animated visible-false" data-appear="zoomIn">
								<img src="images/avatar-anh6.jpg" alt="IGM-AVATAR">
							</div>
			...
			<div class="row">
				...
				<div class="col-sm-6 col-md-4 p-t-50">
					...
					<div class="wrap-gallery-footer flex-w">
						<a class="item-gallery-footer wrap-pic-w" href="images/15.jpg" data-lightbox="gallery-footer">
							<img src="images/15.jpg" alt="GALLERY">
						</a>

						<a class="item-gallery-footer wrap-pic-w" href="images/11.jpg" data-lightbox="gallery-footer">
							<img src="images/11.jpg" alt="GALLERY">
						</a>

						<a class="item-gallery-footer wrap-pic-w" href="images/18.jpg" data-lightbox="gallery-footer">
							<img src="images/18.jpg" alt="GALLERY">
						</a>

						<a class="item-gallery-footer wrap-pic-w" href="images/16.jpg" data-lightbox="gallery-footer">
							<img src="images/16.jpg" alt="GALLERY">
						</a>

						<a class="item-gallery-footer wrap-pic-w" href="images/32.jpg" data-lightbox="gallery-footer">
							<img src="images/32.jpg" alt="GALLERY">
						</a>

						<a class="item-gallery-footer wrap-pic-w" href="images/29.jpg" data-lightbox="gallery-footer">
							<img src="images/29.jpg" alt="GALLERY">
						</a>

						<a class="item-gallery-footer wrap-pic-w" href="images/30.jpg" data-lightbox="gallery-footer">
							<img src="images/30.jpg" alt="GALLERY">
						</a>

						<a class="item-gallery-footer wrap-pic-w" href="images/27.jpg" data-lightbox="gallery-footer">
							<img src="images/27.jpg" alt="GALLERY">
						</a>

						<a class="item-gallery-footer wrap-pic-w" href="images/28.jpg" data-lightbox="gallery-footer">
							<img src="images/28.jpg" alt="GALLERY">
						</a>

						<a class="item-gallery-footer wrap-pic-w" href="images/21.jpg" data-lightbox="gallery-footer">
							<img src="images/21.jpg" alt="GALLERY">
						</a>

						<a class="item-gallery-footer wrap-pic-w" href="images/26.jpg" data-lightbox="gallery-footer">
							<img src="images/26.jpg" alt="GALLERY">
						</a>

						<a class="item-gallery-footer wrap-pic-w" href="images/23.jpg" data-lightbox="gallery-footer">
